...
ACTOR_OPTIMIZER=KLMatchedSOAPPolarLMO
ACTOR_OPTIMIZER_IMPL=verl.utils.kl_matched_soap
ACTOR_MATRIX_DIRECTION=factorized_soap_polar_maxop_lmo_v1
...
ACTOR_OPTIMIZER_OVERRIDE="{matrix_direction: '$ACTOR_MATRIX_DIRECTION', eps: 1e-5, soap_precondition_frequency: 10, soap_max_precond_dim: 2048, auxiliary_eps: 1e-5, alpha_min: $ALPHA_MIN, alpha_max: $ALPHA_MAX, alpha_clamp: $ALPHA_CLAMP, fisher_dataset_path: '$DATA_ROOT/test.parquet', fisher_prompt_indices: $FISHER_PROMPT_INDICES, fisher_micro_batch_size: $FISHER_MICRO_BATCH_SIZE, fisher_probe_count: $FISHER_PROBE_COUNT, fisher_probe_seed: $FISHER_PROBE_SEED, fisher_expected_states: $FISHER_EXPECTED_STATES, fisher_factor_rank: $FISHER_FACTOR_RANK, fisher_dense_threshold: $FISHER_DENSE_THRESHOLD, fisher_refresh_frequency: $FISHER_REFRESH_FREQUENCY}"
